    ...
    <div className="space-y-6">
      <header className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="font-heading text-3xl font-black tracking-normal text-slate-950">My Requests</h1>
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="font-heading mt-2 text-3xl font-black text-slate-950">{totalRequests}</p>
        </div>
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
          <p className="text-sm font-bold text-slate-500">Pending</p>
          <p className="font-heading mt-2 text-3xl font-black text-amber-600">{pendingRequests}</p>
        </div>
        <div className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-slate-200">
